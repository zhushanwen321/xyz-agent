...
2. **设计基线 commit**：确保 `architecture-design.md` + `architecture-review-issues.md` + `changes/tracing-round-1.md` + `migration-plan.md` + `plan/` + **`terminology-alignment-plan.md`**（phase-4 R1–R5 依赖它）已 commit。
