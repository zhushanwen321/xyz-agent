 ...
 * 不依赖静态标记（~/.pi/skills 曾静态标 shared 但不在现有路径 → 判定失真） */
...
<template>
  <div class="page">
    <header class="page-head">
      ...
      <p class="desc">管理 pi agent 启动时可访问的目录。项目目录仅当前项目生效，全局目录所有项目共享。</p>
    </header>
    ...
    <!-- Layer B：已发现的 Skill（spec §5 资源预览） -->
    <section class="rp-card">
      <div class="rp-toolbar">
        <span class="rp-title">已发现的 Skill</span>
