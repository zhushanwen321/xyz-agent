...
|---|---|---|---|
| u0 V5 基线采集 | pending | 无（只读） | 基线留存路径：待登记 |
| u1 M1 包内原子改（E1-E5+changeset） | pending | 待回填 | 已知中间态：subagent-core conformance 暂红至 u2 |
