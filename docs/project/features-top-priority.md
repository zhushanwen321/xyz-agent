...
> ⚠️ **已过时（2026-06-20）**：本清单基于 2026-05-17 状态。其中「Sidecar 编译 / 生产构建」已解决（electron-builder 完整，见 [feature-map/2026-06-20.md §三](../feature-map/2026-06-20.md)）；路径中的 `sidecar/` 已重命名为 `runtime/`。保留作历史参考，最新优先级见 feature-map。
