...
> ⚠️ **已过时（2026-06-20）**：本清单基于 2026-05-17 代码状态，v3 视觉重建前。完成度与模块划分已大幅变化，路径中的 `sidecar/` 已重命名为 `runtime/`。最新状态见 [feature-map/2026-06-20.md](../feature-map/2026-06-20.md)。保留作历史参考。
