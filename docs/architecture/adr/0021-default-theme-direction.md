...
| 主张方 | 默认 | 依据 |
|---|---|---|
| **设计层** | 暗色冷蓝优先（`--bg #1a1b1f`，accent `#4f8ef7`；原 `#0d0d0f`，2026-07-09 提亮校准） | `design-tokens.md`（标题「冷蓝暗色 SSOT」）、`design-system.md §10`（「暗色为主，亮色为辅」）、`PRODUCT.md`、ADR-0018 |
...
产品真实默认 = **暗色冷蓝**（`--bg #1a1b1f` / accent `#4f8ef7`；原 `#0d0d0f`，2026-07-09 提亮校准）。真身代码跟随设计主张（ADR-0018）。
