...
**Status**: Superseded（被 [shell spec](../../page-design/archive/v3/shell/spec.md) + 2026-06-28 折叠态 chrome 落位取代）
**Date**: 2026-06-06
**Superseded by**: `docs/page-design/archive/v3/shell/spec.md`（zcode-demo 拓扑）+ 折叠态 chrome 迁入 P1 PanelHeader 方案
...
> - 现版 SSOT 见 [shell spec](../../page-design/archive/v3/shell/spec.md)。下文为历史决策原文，保留供追溯。
