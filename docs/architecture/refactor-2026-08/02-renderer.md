...
>
> **历史快照（2026-09-11 补注）**：本文为 2026-08-13 审查快照，文中文件路径/行号以当时 HEAD 为准；相关实现（如 `useCodeblockCopy.ts`、`useMessageStreamNotices.ts`）已于 2026-09-11 renderer 过度设计清理批次迁移或删除。
