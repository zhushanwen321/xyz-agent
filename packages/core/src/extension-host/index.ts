/**
 * extension-host —— ExtensionHost 基建与注册中心（W1 barrel，W2 增量）。
 *
 ...
 * MessageBusBridge（W2）。command-registry / activation-manager / status-bar-controller /
 * overlay-lifecycle / view-host-store 等由 w3-w4 交付后追加，不引用未建文件。
 */
export * from './types'
