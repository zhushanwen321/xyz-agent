...
vi.mock('@xyz-agent/core/transport/api/domains/background-task', () => ({ list: (...args: unknown[]) => listMock(...args) }))
 ...
 * viewsSource.getViews / L2 tab / badge 链均消费 builtin 的 background-tasks view 声明。
