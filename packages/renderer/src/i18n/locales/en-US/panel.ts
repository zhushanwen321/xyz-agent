export default {
  ...
  composer: {
    ...
    handoffHint: 'Enter handoff note (optional, describe the focus of the new session)… (⏎ handoff & send, Esc to exit)',
  ...
  message: {
    ...
    handoff: 'Hand off & new session (pack last reply doc into a new session)',
    handoffAsk: 'Hand off with note (hand off in a new session, with focus note)',
    ...
    railFoldAll: 'Fold all',
    railUnfoldAll: 'Expand all',
