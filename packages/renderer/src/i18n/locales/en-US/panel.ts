export default {
  ...
  composer: {
    ...
    command: "Command",
    forkHint:
      "Fork from this reply to ask anything (⏎ fork & send, Esc to exit)",
    forkChip: "Sends to a new branch · isolated from main line",
    forkSend: "fork & send",
    forkExit: "Exit fork mode",
    handoffHint:
      "Enter text to send as the first message in the new session (optional)… (⏎ handoff & send, Esc to exit)",
  ...
  message: {
    ...
    forkBackground:
      "Fork to background (branch from this reply, stay on current line)",
    forkAsk: "Fork to ask (ask in a new branch, isolated from main line)",
    forkFailed: "Fork to background failed: {error}",
    handoff:
      "Hand off & new session (conversation history packed into a new session)",
    handoffAsk:
      "Hand off with note (your text becomes the first message in the new session)",
    ...
    startConversation:
      "Start a conversation, or select a session from the left",
  ...
  sideDrawer: {
    ...
    terminalHint:
      "Real-time output appears after extension pushes terminal widget",
    ...
    gitHint:
      "Open a session in a git repository to view status and stage/commit",
    ...
    noWorkflow: "No workflows",
    workflowHint:
      "Click a workflow in the sidebar Flows tab to view execution visualization",
    workflowDrawer: {
      tabClose: "Close",
      viewDag: "Layers",
      viewGantt: "Timeline",
      ...
      noOpenedRuns: "No workflow opened",
      noOpenedRunsHint:
        "Click a workflow in the sidebar Flows tab to view execution visualization",
    },
    workflowDag: {
      ...
      ganttAxisStart: "Start",
      ganttAxisEnd: "End",
      ganttRunning: "Running",
      ganttHint: "Bar length = duration · Overlap = parallel",
      ganttNoTimeData: "No time data",
    },
  },
  browserPane: {
    back: "Back",
    ...
    loginHint:
      "The embedded browser cannot keep you logged in. Open in system browser.",
    downloadBlocked: "Download blocked",
    downloadHint:
      "Downloads are not supported in the embedded browser. Open in system browser if needed.",
  ...
  panel: {
    ...
    sessionDeadHint:
      "Process terminated unexpectedly. Conversation cannot continue. Try reopening.",
    reopen: "Reopen",
