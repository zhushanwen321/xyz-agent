...
export default {
  ...
  usage: {
    ...
    sessionCount: 'Session files',
    rowCount: 'Aggregated rows',
    skippedLines: 'Skipped {count} unparseable records',
    // ── Ledger ──
    ...
    modelsLabel: 'models',
    total: 'Total',
    ledgerTotalToken: 'Total Token · Last {days} days',
    ledgerTotalTokenAll: 'Total Token · All {days} days',
    ledgerCost: 'Cost (estimated)',
    ledgerCostHint: 'models.json rates',
    ledgerMessages: 'Messages',
    ledgerMessagesHint: 'assistant messages',
    ledgerActiveDays: 'Active days',
    ledgerCacheHit: 'Cache hit rate',
    ledgerCacheHitHint: 'cacheRead ÷ (cacheRead + input)',
    ledgerPeakDay: 'Peak day',
    // ── Legend + Toolbar ──
    legendReset: 'Reset',
    metricToken: 'Token',
    metricCost: 'Cost',
    ...
    tooltipDate: '{date} {weekday}',
    tooltipDayTotal: 'Daily Token',
    tooltipDayCost: 'Daily Cost',
    tooltipInput: '↑ Input',
    tooltipCacheRead: '← Cache Hit',
    ...
    detailColInput: '↑ Input',
    detailColCacheRead: '← Cache Read',
    detailColCacheWrite: '→ Cache Write',
    detailColOutput: '↓ Output',
    detailColToken: 'Token',
    detailColCost: 'Cost',
    detailColShare: 'Share',
    detailModelsCount: '{count} models',
    detailTotal: 'Total',
    // ── Empty state ──
