...
export default {
  ...
  usage: {
    ...
    sessionCount: '会话文件',
    rowCount: '聚合行',
    skippedLines: '跳过 {count} 行无法解析的记录',
    // ── 摘要台账行 ──
    totalTokens: '总 Token',
    recentDays: '近 {n} 天',
    cost: '费用（估算）',
    ...
    modelsLabel: '模型',
    total: '合计',
    ledgerTotalToken: '总 Token · 近 {days} 天',
    ledgerTotalTokenAll: '总 Token · 全部 {days} 天',
    ledgerCost: '费用（估算）',
    ledgerCostHint: 'models.json 费率',
    ledgerMessages: '消息数',
    ledgerMessagesHint: 'assistant 消息',
    ledgerActiveDays: '活跃天',
    ledgerCacheHit: '缓存命中率',
    ...
    detailColModel: '模型',
    detailColInput: '↑ 输入',
    detailColCacheRead: '← 缓存读',
    detailColCacheWrite: '→ 缓存写',
    detailColOutput: '↓ 输出',
    detailColToken: 'Token',
    detailColCost: '费用',
    detailColShare: '占比',
    detailModelsCount: '{count} 模型',
    detailTotal: '合计',
    // ── 空态 ──
    emptyTitle: '还没有会话记录',
