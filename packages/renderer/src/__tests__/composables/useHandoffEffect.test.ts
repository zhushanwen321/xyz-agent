 ...
 * - vi.mock('@/composables/features/sidebar/useSidebarNew')：loadSessions / selectSession 用 vi.fn（可 reject 测失败路径）。
...
// ── useSidebarNew mock：捕获 loadSessions/selectSession（不引入真实 useSidebarNew 的 30+ 依赖）──
