...
import { Settings, Sparkles, Bot, Blocks, SlidersHorizontal, ScrollText, TerminalSquare, GitBranch, ClipboardList, X, Download, Palette, ArrowLeft, ArrowRight, PanelLeftClose } from '@lucide/vue'
