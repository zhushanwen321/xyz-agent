<template>
  ...
  >
    ...
    <div v-else class="flex flex-col gap-1">
      ...
      <p v-if="summaryLine" class="pl-4 text-[12px] leading-snug text-neutral-mid line-clamp-1">{{ summaryLine }}</p>
      ...
      <template v-if="expanded">
        ...
        <div v-if="fullContent" class="ml-4 max-h-[200px] overflow-y-auto rounded-sm bg-surface-2/50 px-2 py-1 text-[11px] leading-relaxed text-neutral-mid">
