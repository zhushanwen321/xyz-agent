<template>
  <!--
    ...
    Wave 3：在此挂载 Sidebar 容器（FG3），padding-top:24px(pt-6) 安全区让出 traffic light（原生位置 y=8~20）。
  -->
  <aside
    class="relative flex flex-col overflow-hidden pt-6"
    :style="{
...
// pt-6(24px) traffic light 安全区：红黄绿原生位置 y=8~20，Sidebar 内容从 y=24 起避免遮挡；
