 ...
 *
 * 返回 pi-ai 的 Message[]（completeSimple 的 Context.messages 契约）。前缀来自
 * entry.message（SessionMessageEntry.message 即 AgentMessage，是 Message 的超集），
 * 末尾的 rename 指令补齐 UserMessage 必填的 timestamp 字段。
 */
