...
export default function visionExtension(pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		async execute(_toolCallId: string, params: Static<typeof AnalyzeImageParams>, signal: AbortSignal | undefined, onUpdate: AgentToolUpdateCallback<VisionDetails | undefined> | undefined, ctx: ExtensionContext) {
			cleanupOldTempFiles();
		...
		renderResult(result: AgentToolResult<VisionDetails | undefined>, options: ToolRenderResultOptions, theme: Theme) {
