...
- 4955dad6e: Make session entries the single source of truth and delete the dead session-tier machine.
...
- 7b33e6f00: **todo / pending-notifications: dead-surface and type cleanup from the drift-cleanup sweep**
