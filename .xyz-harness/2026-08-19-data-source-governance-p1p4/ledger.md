...
| W12 | 5 个 state 话题切实例快照发布 | building | 996063a6f | 依赖 W7/W8✓；builder 后台运行中（5 阶段各独立自验，主 agent 分 5 次 commit；W8 minor protocol.ts queue_update 补 pendingMessageCount + W10 minor index.ts:273-276 注释清理顺带） |
