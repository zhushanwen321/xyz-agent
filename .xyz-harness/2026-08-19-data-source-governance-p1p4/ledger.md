...
| W19 | session_end sidecar 登记收口 | building | — | 依赖 W2✓/W11✓；builder 后台运行中（小 wave ≤30 行；acceptance 旧名 persistHandedOff 已按 W11 改名 persistHandoffSidecar 校正进派发词；W11 verifier 移交观察项——delete 链不清理 .handoff.json/.project.json sidecar——由本 wave 处置：≤30 行收口或登记草稿） |
