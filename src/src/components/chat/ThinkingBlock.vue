...
.thinking-label { font-size: 11px; font-family: var(--font-mono); color: var(--color-text-muted); }
...
.thinking-text { white-space: pre-wrap; font-family: var(--font-mono); font-size: 11px; line-height: 1.5; color: var(--color-text-muted); margin: 0; }
